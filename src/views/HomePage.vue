...
export default {
  ...
  methods: {
    ...
    onFirstAnimationFinished() {
      // Trigger any additional animations after typing completes
...
.home {
  ...
  // Override any global page styles that add padding/margin
  &.page {
    padding: 0 !important;
    margin: 0 !important;
  }
...
// Projects Section - Professional styling matching other pages
.section--projects {
  padding: 6rem 0;
